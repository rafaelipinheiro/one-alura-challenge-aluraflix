  ...
  return (
    <>
      <StyledFooter>
        ...
        <Container>
          <TextFooter>
            Desenvolvido por Rafaeli Pinheiro
          </TextFooter>

          <NavStyled>
            <NavItem to="https://github.com/rafaelipinheiro" target="_blank">
              <IconGithub />
            </NavItem>
            <NavItem to="https://www.linkedin.com/in/rafaelipinheiro" target="_blank">
              <IconLinkedin />
            </NavItem>
          </NavStyled>
        </Container>
